...
description: "A quickstart for writing Salesforce Aura (aka Lightning) components. Covers component structure, controllers, the Salesforce ecosystem context, and how Locker Service (Lightning Locker) provides security by preventing one Aura component from traversing the DOM into another."
image: /assets/2017-3-28/aura-logo.png
---

{% include image.html link=true src="/assets/2017-3-28/aura-logo.png" alt="Salesforce Aura framework logo" width=596 height=222 loading="eager" fetchpriority="high" %}
...
{% include image.html link=true src="/assets/2017-3-28/without-locker.png" alt="Diagram showing component isolation without Lightning Locker Service" width=2346 height=1706 %}
...
{% include image.html link=true src="/assets/2017-3-28/with-locker.png" alt="Diagram showing component isolation with Lightning Locker Service enabled" width=2382 height=1782 %}
...
{% include image.html link=true src="/assets/2017-3-28/developer-console.png" alt="Salesforce developer console showing an Aura component" width=1594 height=624 %}
