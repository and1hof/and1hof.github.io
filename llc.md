---
layout: default
title: Andrew Hoffman LLC
permalink: /llc/
description: Andrew Hoffman LLC — application security consulting, books, and products.
---
...
<script type="application/ld+json">
{
  ...
  "url": "{{ site.url }}/llc/",
  "logo": "{{ site.url }}/assets/ah-llc-watermark.png",
  "description": "Application security consulting, books, and products by Andrew Hoffman. Services include threat modeling, secure design review, penetration testing, and security training for web and web3 applications.",
  "founder": {
    "@type": "Person",
    "name": "Andrew Hoffman",
    "url": "{{ site.url }}/about/"
...
<div class="llc-grid">
  ...
  <article class="llc-card">
    ...
    <div class="llc-actions">
      <a class="llc-btn llc-btn-primary" href="https://amzn.to/48ycZzk" target="_blank" rel="noopener noreferrer">2nd Edition</a>
      <a class="llc-btn llc-btn-secondary" href="https://amzn.to/3LU0QN2" target="_blank" rel="noopener noreferrer">1st Edition</a>
    </div>
  </article>
